...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function enter() public payable {
        require(lottery_state == LOTTERY_STATE.OPEN, "Lottery is not yet opened");
        require(msg.value >= getEntranceFee(), "Not enough amount for entering");
